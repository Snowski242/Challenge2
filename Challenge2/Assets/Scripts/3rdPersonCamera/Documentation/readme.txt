----------------------------------------------
            3rd Person Camera
 Copyright © 2015-2023 Thomas Enzenebner
            Version 1.0.7.3
...
-----------------
1.0.7.3
	- removed disable time from LockOnTarget
	- fixed LockOn with CameraMode set to Always
	- Added HandleLockOnTargets script which will automatically add/remove targets
	  For setup: Add HandleLockOnTargets and a Sphere Collider with 'Is Trigger' enabled to the
	  target or player. Also set the radius accordingly.
1.0.7.2
