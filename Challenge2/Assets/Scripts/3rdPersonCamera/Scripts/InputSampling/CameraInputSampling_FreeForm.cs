...
namespace ThirdPersonCamera
{
    ...
    public class CameraInputSampling_FreeForm : MonoBehaviour
    {
        ...
        [Tooltip("Enable rotating the camera with the keyboard")]
        public bool keyboardRotationEnabled = false;
        [Tooltip("The keys with which to rotate. Counter clockwise list. Up/Left/Down/Right")]
        public List<KeyCode> keyboardRotationKeys = new List<KeyCode>()
        {
            KeyCode.I,
            KeyCode.J,
            KeyCode.K,
        ...
        [Tooltip("The speed with which to rotate when using the keyboard")]
        public float keyboardRotationSpeed = 1.0f;
        ...
        public void Start()
        {
            ...
            HasLockOnComp = lockOnTarget != null;
        ...
        public void Update()
        {
            ...
            {
                if (Input.GetKey(keyboardRotationKeys[0])) // top
                    y += keyboardRotationSpeed;
                if (Input.GetKey(keyboardRotationKeys[1])) // left
                    x -= keyboardRotationSpeed;
                if (Input.GetKey(keyboardRotationKeys[2])) // down
                    y -= keyboardRotationSpeed;
                if (Input.GetKey(keyboardRotationKeys[3])) // right
                    x += keyboardRotationSpeed;
            ...
            // update values
            if (HasLockOnComp && lockOnTarget.HasFollowTarget)
                inputFreeForm.inputFreeLook = false;
            else
